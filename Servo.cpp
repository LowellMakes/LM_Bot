...
void Servo::writeDegrees(int deg)
{
	writeMicroseconds(map(deg, MIN_SERVO_DEGREES, MAX_SERVO_DEGREES, MIN_SERVO_MILLISEC, MAX_SERVO_MILLISEC));
}

int Servo::readDegrees()
{
	return map(readMicroseconds(), MIN_SERVO_MILLISEC, MAX_SERVO_MILLISEC, MIN_SERVO_DEGREES, MAX_SERVO_DEGREES);
}
